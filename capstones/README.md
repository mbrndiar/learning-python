...
Start them after Chapters 1–19 and the required
[Task REST API and clients project](../projects/tasks/README.md). In particular,
Chapter 15 supplies SQL/SQLite, Chapters 16–18 supply HTTP boundaries, the applied
project combines those skills, and Chapter 19 supplies concurrency.
